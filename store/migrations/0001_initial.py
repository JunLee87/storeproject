    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(blank=True, unique=True, verbose_name='收货地址', max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_url_i',
                 models.ImageField(default='clothing/default.jpg', verbose_name='展示图片路径', upload_to='clothing/%Y/%m')),
                ('image_url_l',
                 models.ImageField(default='clothing/default.jpg', verbose_name='详情图片路径1', upload_to='clothing/%Y/%m')),
                ('image_url_m',
                 models.ImageField(default='clothing/default.jpg', verbose_name='详情图片路径2', upload_to='clothing/%Y/%m')),
                ('image_url_r',
                 models.ImageField(default='clothing/default.jpg', verbose_name='详情图片路径3', upload_to='clothing/%Y/%m')),
                ('brand', models.ForeignKey(verbose_name='品牌', to='store.Brand', on_delete=models.CASCADE)),
                ('category', models.ForeignKey(verbose_name='分类', to='store.Category', on_delete=models.CASCADE)),
            ],
            options={
                'verbose_name': '商品',
                'ordering': ['id'],
